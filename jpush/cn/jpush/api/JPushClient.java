...
public class JPushClient {
	...
	public UsersResult getReportUsers(TimeUnit timeUnit, String start, int duration) throws APIConnectionException,
			APIRequestException {
	 ...
	 * Shortcut
	 */
	public PushResult sendAndroidNotificationWithAlias(String title, String alert, Map<String, String> extras,
		...
		PushPayload payload = PushPayload.newBuilder().setPlatform(Platform.android())
				.setAudience(Audience.alias(alias)).setNotification(Notification.android(alert, title, extras)).build();
		return _pushClient.sendPush(payload);
	}
	 ...
	 * Shortcut
	 */
	public PushResult sendAndroidNotificationWithRegistrationID(String title, String alert, Map<String, String> extras,
			String... registrationID) throws APIConnectionException, APIRequestException {
		PushPayload payload = PushPayload.newBuilder().setPlatform(Platform.android())
	 ...
	 * Shortcut
	 */
	public PushResult sendIosNotificationWithRegistrationID(String alert, Map<String, String> extras,
			String... registrationID) throws APIConnectionException, APIRequestException {
		PushPayload payload = PushPayload.newBuilder().setPlatform(Platform.ios())
				.setAudience(Audience.registrationId(registrationID)).setNotification(Notification.ios(alert, extras))
				.build();
		return _pushClient.sendPush(payload);
	}
	 ...
	 * Shortcut
	 */
	public PushResult sendAndroidNotification(String title, String alert, Map<String, String> extras)
			throws APIConnectionException, APIRequestException {
	 ...
	 * Shortcut
	 */
	public PushResult sendIosNotification(String alert, Map<String, String> extras) throws APIConnectionException,
			APIRequestException {
	 ...
	 * @throws APIRequestException
	 */
	public PushResult sendAllMessageWithAlias(String title, String msgContent, String... alias)
			throws APIConnectionException, APIRequestException {
	 ...
	 * @throws APIRequestException
	 */
	public PushResult sendAllMessageWithRegistrationID(String title, String msgContent, String... registrationID)
			throws APIConnectionException, APIRequestException {
	 ...
	 * @throws APIRequestException
	 */
	public PushResult sendAllMessage(String title, String msgContent) throws APIConnectionException,
			APIRequestException {
