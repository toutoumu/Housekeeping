...
<%
	...
	// 查询业务类别
	BusinessCategory businessCategory = businessCategoryService.getBusinessCategory(Integer
	.parseInt(businessCategoryId));
...
<body>
  <div data-role="page" id="logopage">
    ...
    <script type="text/javascript" src="/Housekeeping/mobile/newhouse/xj_order_add.js"></script>
