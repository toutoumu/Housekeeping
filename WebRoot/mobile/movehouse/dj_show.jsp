...
<body>
  <div data-role="page" id="logopage">
    <script type="text/javascript" src="/Housekeeping/mobile/movehouse/dj_show.js"></script>
      ...
      <div class="ui-content">
        <table width="100%">
          <tr>
            <td>
              <a
                href="/Housekeeping/mobile/movehouse/dj_order_add.jsp?employeeId=<%=employeeId%>&businessCategoryId=<%=businessCategoryId%>"
