...
<body>
  <div data-role="page" id="logopage">
    <script type="text/javascript" src="/Housekeeping/mobile/movehouse/dj_order_info.js"></script>
      ...
      <ul data-role="listview" data-split-icon="gear" data-theme="c" data-inset="false">
        ...
        <ul data-role="listview" data-split-icon="gear" data-theme="d" data-inset="true">
          <c:forEach var="emp" items="${employees }">
            <li>
              <a href="/Housekeeping/mobile/movehouse/dj_show.jsp?employeeId=${emp.id }&pageType=read"
                data-ajax="true">
