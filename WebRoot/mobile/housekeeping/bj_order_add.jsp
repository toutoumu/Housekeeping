...
<body>
  <div data-role="page" id="logopage">
    ...
    <script type="text/javascript" src="/Housekeeping/mobile/housekeeping/bj_order_add.js"></script>
          ...
          <li>
            <table width="100%">
              <tr>
                <td>消耗物品</td>
                <td>
                  <input type="text" readonly="readonly" name="fname" id="Text2" value="洗洁精等消耗品需加5元/时" />
                </td>
              </tr>
            </table>
          </li>
