...
<body>
  <div data-role="page" id="logopage">
    ...
    <script type="text/javascript" src="/Housekeeping/mobile/housekeeping/bj_list.js"></script>
    ...
    <div class="ui-content" role="main">
      <ul data-role="listview" data-split-icon="gear" data-theme="d" data-inset="true">
        <c:forEach var="emp" items="${emList }">
          <li>
            <a
              href="/Housekeeping/mobile/housekeeping/bj_show.jsp?employeeId=${emp.id }&businessCategoryId=<%=businessCategoryId%>&pageType=order"
              data-ajax="true">
    ...
    <div data-role="footer" data-position="fixed" data-theme="c">
      <div class="ui-content">
        <a href="/Housekeeping/mobile/housekeeping/bj_order_add.jsp?businessCategoryId=<%=businessCategoryId%>"
          data-ajax="true" data-role="button" data-theme="e" class="footer_btn_a" style="color: #fff">快速预约</a>
      </div>
    </div>
  </div>
  <!-- /page -->
