...
<script src="modules/businessCategory_management/businessCategory.js"></script>
<title>业务类别管理</title>
</head>
<body class="claro">
	<div data-dojo-type="dijit.layout.BorderContainer"
		...
		<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'top'"
			...
			<div dojoType="dijit.TitlePane" title="查询" style="margin: 0px; padding: 0px;">
				<div data-dojo-type="dijit/form/Form" id="myForm" data-dojo-id="myForm" encType="multipart/form-data" action=""
					...
					<label width="90px" style="visibility: hidden;">业务类别名称</label>
					<input data-dojo-id="caName" id="caName" style="margin-left: 5px; visibility: hidden;" type="text" name="name"
						required="false" data-dojo-type="dijit/form/ValidationTextBox" />
					<span style="text-align: right; float: right;">
						<button data-dojo-type="dijit/form/Button" type="button" name="submitButton" value="Submit" onclick="query()">刷新</button>
		...
		<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'center'" id="grida"
			...
			<table data-dojo-type="dojox/grid/DataGrid" id="grid" rowsPerPage="15" rowSelector="20px" region="center"
				...
				<thead>
					<tr>
						<th field="name" width="100px">服务分类名称</th>
		...
		<!-- 弹出窗体添加 -->
		<div data-dojo-type="dijit/Dialog" data-dojo-id="addDialog" title="添加业务分类">
