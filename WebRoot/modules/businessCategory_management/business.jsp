...
<script src="modules/businessCategory_management/business.js"></script>
<title>业务管理</title>
</head>
<body class="claro">
	<div data-dojo-type="dijit.layout.BorderContainer"
		...
		<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'top'"
			...
			<div dojoType="dijit.TitlePane" title="查询" style="margin: 0px; padding: 0px;">
				<div data-dojo-type="dijit/form/Form" id="myForm" data-dojo-id="myForm" encType="multipart/form-data" action=""
					...
					<label width="90px">业务类别名称</label>
					<input data-dojo-id="cbbCategory" id="cbbCategory" style="margin-left: 5px;" type="text" name="name"
						required="false" data-dojo-type="dijit/form/FilteringSelect" />
		...
		<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'center'" id="grida"
			...
			<table data-dojo-type="dojox/grid/DataGrid" id="grid" rowsPerPage="15" rowSelector="20px" region="center"
				...
				<thead>
					<tr>
						<th field="name" width="100px">业务名称</th>
						...
						<th field="id" width="80px" formatter="formatterEditDetail">...</th>
						<th width="auto"></th>
					</tr>
				</thead>
			</table>
		...
		<!-- 弹出窗体添加 -->
		<div data-dojo-type="dijit/Dialog" data-dojo-id="addDialog" title="添加业务">
		...
		<!-- 弹出窗体编辑 -->
		<div data-dojo-type="dijit/Dialog" data-dojo-id="editDialog" title="编辑业务分类">
			<div data-dojo-type="dijit/form/Form" id="editForm" data-dojo-id="editForm" encType="multipart/form-data"
				...
				<table style="border: 1px solid #9f9f9f; width: 100%;" cellspacing="10">
					<tr>
						<!-- <td>前台显示</td>
						<td>
							<input type="text" name="visiblity" data-dojo-props="value:true" data-dojo-id="checkbox" required="true"
						...
						<td>备注</td>
						<td>
							<input type="text" name="remark" required="true" maxlength="100"
								data-dojo-type="dijit/form/ValidationTextBox" />
						</td>
					</tr>
				</table>
